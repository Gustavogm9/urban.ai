...
async def fetch_js_for_hash():
    async with aiohttp.ClientSession() as session:
        ...
        print("Fetching airbnb search page...")
        async with session.get('https://www.airbnb.com.br/s/Itacare/homes', headers=headers) as resp:
        ...
        print(f"Found {len(js_urls)} JS files. Scanning...")
        
        # Parallel fetch and search
        ...
        if valid:
            ...
            print("Query name not found in JS bundles.")
